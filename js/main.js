window.addEventListener("load", () => {
  ...
  let footerProducts = document.getElementById("footerProducts");
...
(function ($) {
  ...
  // Product
  $("#yarnBtn").addClass("active");
  $("#fabricBtn").removeClass("active");
  $("#yarnProducts").show();
  $("#fabricProducts").hide();
  $(document).on("click", "#yarnBtn", function () {
    $("#yarnBtn").addClass("active");
    $("#fabricBtn").removeClass("active");
    $("#yarnProducts").show();
    $("#fabricProducts").hide();
  });
  $(document).on("click", "#fabricBtn", function () {
    $("#fabricBtn").addClass("active");
    $("#yarnBtn").removeClass("active");
    $("#fabricProducts").show();
    $("#yarnProducts").hide();
  });
  ...
  $(".category-list").on("click", "li", function () {
    ...
    if (id === "lightweightBtn") {
      ...
      $("#fabricFour").hide();
      $("#fabricFive").hide();
    } else if (id === "texturedBtn") {
      $("#fabricOne").hide();
      $("#fabricTwo").hide();
      $("#fabricThree").hide();
      $("#fabricFour").show();
      $("#fabricFive").hide();
    } else if (id === "structuredBtn") {
      $("#fabricOne").hide();
      $("#fabricTwo").hide();
      $("#fabricThree").hide();
      $("#fabricFour").hide();
